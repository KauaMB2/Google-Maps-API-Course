...
async function initMap() {
    ...
    var mapOptions = {//Defines the options
        ...
        //ATTENTION!!!!!!!!!!!!!!
        //You must use this site to facilitate the map style settings: https://mapstyle.withgoogle.com
        styles: [//defines the style of the map
            {
                "elementType": "geometry",//The kind of data will be changed
                "stylers": [//parameters will be changed
                    {
                        "color": "#242f3e"//parameter
                    }
                ]
            },
            {
